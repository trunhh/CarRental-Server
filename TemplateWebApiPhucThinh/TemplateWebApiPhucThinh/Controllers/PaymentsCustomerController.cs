...
namespace TemplateWebApiPhucThinh.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class PaymentsCustomerController : ControllerBase
    {
        ...
        public PaymentsCustomerController(IPaymentsCustomerRepository repository)
        {
        ...
        [HttpPost]
        [Route("Create")]
        public IActionResult Create([FromBody] PaymentsCustomer PaymentsCustomer)
        {
            PaymentsCustomer.Id = Guid.NewGuid() + "";
            PaymentsCustomer.IsDelete=false;
            return Ok(_repository.Create(PaymentsCustomer));
        }
        ...
        [HttpPut]
        [Route("Update/{id}")]
        public IActionResult Update(string id, [FromBody] PaymentsCustomer PaymentsCustomer)
        {
            return Ok(_repository.Update(id, PaymentsCustomer));
        }
        [HttpGet]
